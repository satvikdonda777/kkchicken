          ...
          children: [
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemCount: homeProvider.offerModel!.offer!.length,
                ...
                itemBuilder: (context, index) {
                  Map<String, dynamic> jsonModel =
                      homeProvider.offerModel!.toJson();
                  HomeData homeData =
                      HomeData.fromJson(jsonModel['data'][index]);
                  return ChickenFoodCard(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(
                        builder: (context) {
                          return FoodDetailScreen(chickenFoodModel: homeData);
                        },
                      ));
                      // context.router.push(
                      //     FoodDetailScreenRoute(chickenFoodModel: homeData));
                    },
                    chickenFoodModel: homeData,
                    onAddTap: () {
                      homeProvider.addProductToCart(context, homeData);
                    },
                  );
                },
              ),
